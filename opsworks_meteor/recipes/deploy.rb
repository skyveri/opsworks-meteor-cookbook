bash "Deploy Meteor" do
  ...
  echo "process.env.MONGO_URL = 'http://54.84.83.86'; process.env.MONGO_URL = 'mongodb://skyveri_readonly:Feiun5s09@oceanic.mongohq.com:10016/skyveri_main'; process.env.PORT = 80; require('./bundle/main.js'); " > server.js
